  ...
  return (
    <div style={styles.overlay}>
      <div style={styles.container}>
        ...
        <EnterXRButton store={store} />
      </div>
    </div>
  )
}

const EnterXRButton = ({ store }: { store: XRStore }) => {
  const vr = useXRSessionModeSupportedPolling('immersive-vr')
  const ar = useXRSessionModeSupportedPolling('immersive-ar')
